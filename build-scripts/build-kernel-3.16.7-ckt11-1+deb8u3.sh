##############################################
# only works for linux-3.16.7-ckt11-1+deb8u3 #
#                                            #
...
make -j8 deb-pkg LOCALVERSION=-ustclugsigned+deb8u3 DEBFULLNAME="Shengjing Zhu" \
...
aptly snapshot create linux-3.16.7-ckt11-1+deb8u3 from repo linux-ustclugsigned
aptly publish switch jessie linux-3.16.7-ckt11-1+deb8u3
