#######################################
# only works for linux-3.16.7-ckt11-1 #
#                                     #
...
aptly snapshot create linux-3.16.7-ckt11-1 from repo linux-ustclugsigned
aptly publish snapshot linux-3.16.7-ckt11-1
